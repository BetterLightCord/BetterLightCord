...
*/
    _keydown: (...args) => {console.log(`_keydown called with ${args.join(", ")}`);},
    keyup: (...args) => {console.log(`keyup called with ${args.join(", ")}`);},
    focused: (...args) => {console.log(`focused called with ${args.join(", ")}`);},
    blurred: (...args) => {console.log(`blurred called with ${args.join(", ")}`);},
    ...
    inputEventUnregister: (...args) => {console.log(`inputEventUnregister called with ${args.join(", ")}`);},
    inputWatchAll: (...args) => {console.log(`inputWatchAll called with ${args.join(", ")}`);},
    inputSetFocused: (...args) => {console.log(`inputSetFocused called with ${args.join(", ")}`);},
    inputGetRegisteredEvents: (...args) => {console.log(`inputGetRegisteredEvents called with ${args.join(", ")}`);},
    setCandidateGamesCallback: (...args) => {console.log(`setCandidateGamesCallback called with ${args.join(", ")}`);},
    setObservedGamesCallback: (...args) => {console.log(`setObservedGamesCallback called with ${args.join(", ")}`);},
    setGameCandidateOverrides: (...args) => {console.log(`setGameCandidateOverrides called with ${args.join(", ")}`);},
    setProcessPriority: (...args) => {console.log(`setProcessPriority called with ${args.join(", ")}`);},
    getPidFromWindowHandle: (...args) => {console.log(`getPidFromWindowHandle called with ${args.join(", ")}`);},
    getWindowHandleFromPid: (...args) => {console.log(`getWindowHandleFromPid called with ${args.join(", ")}`);},
    generateSessionFromPid: (...args) => {console.log(`generateSessionFromPid called with ${args.join(", ")}`);},
    getAudioPid: (...args) => {console.log(`getAudioPid called with ${args.join(", ")}`);},
    ...
    _generateLiveMinidump: (...args) => {console.log(`_generateLiveMinidump called with ${args.join(", ")}`);},
    nativePermissionRequestAuthorization: (...args) => {console.log(`nativePermissionRequestAuthorization called with ${args.join(", ")}`);},
    nativePermissionHasAuthorization: (...args) => {console.log(`nativePermissionHasAuthorization called with ${args.join(", ")}`);},
    nativePermissionOpenSettings: (...args) => {console.log(`nativePermissionOpenSettings called with ${args.join(", ")}`);},
    shouldDisplayNotifications: (...args) => {console.log(`shouldDisplayNotifications called with ${args.join(", ")}`); return true;},
  };
} else {
